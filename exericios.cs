...
// else
//     Console.WriteLine("A resposta é menor que 10.");


// // Faça if and else funcionar juntas
// int a = 5;
// int b = 3;
// if (a + b > 10)
// {
...
{
    Console.WriteLine("A resposta é maior do que 10");
    Console.WriteLine("ou o primeiro número é igual o segundo.");
}
else
{
    Console.WriteLine("A resposta não é maior que 10");
